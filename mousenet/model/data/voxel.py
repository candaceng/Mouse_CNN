...
from mouse_connectivity_models.mcmodels.core import VoxelModelCache
from mousenet.model.data.Data import Data
from mousenet.model.data.FlatMap import FlatMap
...
def get_data_folder():
    ...
    return os.path.join(project_root,  "..", "config", "data_files")
